<template>
  <div class="row d-flex viewpoints_top_container admin_top_container adminOrders_top_container">
    <div class="col-3 col-lg-2">
      <h2 class="fs-2 fw-bold">景點</h2>
    </div>
    <div class="col-6 col-lg-3 col-lg-2 viewpoints_area_container adminOrders">
      <select
        name="timeSort"
        id="timeSort"
...
export default {
  ...
  methods: {
    ...
    updateIsEnabled() {
      // 根據勾選狀態來更改 editTemplateProduct.is_enabled 的值
      if (this.editTemplateProduct.is_enabled) {
        this.editTemplateProduct.is_enabled = 1
      } else {
        this.editTemplateProduct.is_enabled = 0
      }
    }
  },
  mounted() {
